...
public class AuthorizationFilter implements Filter {
    ...
    private static final Set<String> CLIENT_PATH = Set.of(IMAGES, ADD_CLIENT_INFO, CLIENT_BOOKINGS, CREATE_BOOKING, AVAILABLE_CARS, SEE_INFO_ABOUT_BOOKING, DOWNLOAD_CLIENT, CREATE_CLIENT_REPORT);
    private static final Set<String> ADMINISTRATOR_PATH = Set.of(IMAGES, CLIENTS, ADD_CAR, CARS, BOOKINGS, CHECK_BOOKING_EXISTING, DOWNLOAD_ADMIN, CHECK_BOOKING, CREATE_ADMIN_REPORT);
