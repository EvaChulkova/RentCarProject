...
public class AuthorizationFilter implements Filter {
    ...
    private static final Set<String> CLIENT_PATH = Set.of(IMAGES, ADD_CLIENT_INFO, CLIENT_BOOKINGS, CREATE_BOOKING, AVAILABLE_CARS, SEE_INFO_ABOUT_BOOKING, DOWNLOAD_CLIENT_REPORT, SEND_CANCEL_MESSAGE, PERSONAL_CLIENT_INFO);
